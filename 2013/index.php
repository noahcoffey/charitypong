<?php include_once("inc/header.php"); ?>
	...
	<div class="row page">
		<div class="ninecol">
			...
			<div class="info">
			    <h2>Play with us!</h2>
			    <p>The heart of this event is a friendly <strong>singles table tennis tourney</strong> with each game played to <strong>21</strong>. There will be both a winners and 'second chance' bracket, both involving prizes for the winners.</p>
